operacion = input (" 1 para Suma , 2 para Resta, 3 Multiplicación, 4 División, 5 Potencia, 6 para Raiz, 7 para Suma de potencias, 8 para Promedio 9 Comparación entre A y B igualdad y número mayor :")
